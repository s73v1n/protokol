...
class Dashboard_model extends CI_Model {
	...
	{
		$this->db->select('tbl_giat.id as id, tbl_giat.title as title, tbl_giat.start as start, tbl_giat.end as end, tbl_giat.description as description, tbl_giat.penyelengara as penyelenggara, tbl_diposisi.perangkat as disposisi, tbl_giat.keterangan as keterangan ');
