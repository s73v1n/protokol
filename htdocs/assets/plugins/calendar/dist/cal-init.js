    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        var $this = this;
            ...
            form.find(".form-group")
				...
				.append("<div class='form-group'><label class='control-label'>Mulai</label><select class='form-control' name='beginning'></select></div>")
                .append("<div class='form-group'><label class='control-label'>Akhir</label><select class='form-control' name='ending'></select></div>")
